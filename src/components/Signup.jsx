...
const Signup = () => {
    ...
    const handlesubmit = async (e) => {
        ...
        try {
            const response = await axios.post("https://venelahiggs.alwaysdata.net/api/signup", formdata)
        ...
        <div className="row mt-3 justify-content-center">
            <div className="col-md-6 card shadow p-4 ">
                ...
                <form action="" onSubmit={handlesubmit}>
                    ...
                    <input type="text" className="form-control" placeholder="Enter Password" onChange={(e) => { setPassword(e.target.value); checkPasswordStrength(e.target.value) }} />
                    {
                        password && (
                            <p style={{
                                color: strength === "Weak"
